...
export default function LogIn() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string().matches(/^[a-zA-Z1-9]{8,}$/, "password invalid").required(),
    ...
    <>
      ...
      <div className="container">
        ...
        <div className='w-5/12 mx-auto py-12'>
          <h2 className='my-10 text-2xl md:text-5xl '>login now:</h2>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <button type='submit' className='btn mt-2 border ms-auto bg-main text-white' disabled={!(formik.isValid && formik.dirty)}>Login</button>
          </form>
        </div>
      </div>
    </>
